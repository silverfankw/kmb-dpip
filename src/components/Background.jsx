    ...
    return (
        <div className={`fixed inset-0 -z-10 overflow-hidden ${isLightMode ? "bg-[#fdfefe]" : "bg-[#0a1022]"}`}>
            <div className={isLightMode
                ...
                : "absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.22),transparent_28%),radial-gradient(circle_at_top_right,rgba(168,85,247,0.18),transparent_24%),radial-gradient(circle_at_bottom,rgba(59,130,246,0.16),transparent_30%),linear-gradient(160deg,#0a1022_0%,#13203a_52%,#1e293b_100%)]"}
            />
            <div className={isLightMode
